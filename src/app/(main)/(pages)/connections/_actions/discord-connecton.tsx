...
export default async function onDiscordConnect(
    channel_id: string,
    webhook_id: string,
    webhook_name: string,
    webhook_url: string,
...
export async function getDiscordConnectionUrl() {
...
export async function postContentToWebHook(content: string, url: string) {
    console.log(content)
    if (content != '') {
